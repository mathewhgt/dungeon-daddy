...
export const DEFAULT_TEMPLATES: Record<EntityType, TemplateDefinition> = {
  ...
  campaignNote: {
    ...
    csvHeaders: ['name', 'category', 'parent', 'campaign', 'isFolder', 'content', 'isPlayerVisible', 'tags'],
    fields: [
      { key: 'name', label: 'Note or Folder Title', type: 'string', required: true, exampleValue: 'Chapter 1: The Goblin Ambush' },
      { key: 'category', label: 'Category', type: 'enum', options: ['Session', 'Lore', 'NPC', 'Location', 'Quest', 'Handout', 'Folder'], required: true, defaultValue: 'Lore', exampleValue: 'Location' },
